...
<div class="container mt-5">
        <div class="row justify-content-center">
            <h1 class="text-start mb-5" style="font-size: 1.5rem;">Iniciar Sesión</h1>
            ...
            <div class="col-md-6" style="padding-left: 65px;">
                ...
                <div class="d-flex justify-content-between">
                    <asp:Button ID="btnLogin" runat="server" CssClass="btn btn-dark" Text="Iniciar Sesión" />
                    <asp:Button ID="btnRegister" runat="server" CssClass="btn btn-outline-secondary" OnClick="btnRegister_Click" Text="Registrarse" />
                    <asp:Button ID="btnOlvido" runat="server" CssClass="btn btn-link text-muted" Text="¿Olvidaste tu contraseña?" />
                </div>
