        ...
        <div class="col-lg-6 col-md-6 col-12 order-1 order-md-2">
            <div class="section-title ml-lg-5">
                ...
                <h4 class="title mb-4">
                    ...
                    provide you with the best in fashion.
                </h4>
                <p class="text-muted mb-0">At our store, we offer the latest trends in clothing, always with the best quality and at the best prices. Explore our collection and find your unique style.</p>

                <div class="row">
                    <div class="col-lg-6 mt-4 pt-2">
                        <div class="media align-items-center rounded shadow p-3" >
                            <h6 class="ml-3 mb-0 text-dark">Sustainable Fashion</h6>
                        </div>
                    </div>
                    <div class="col-lg-6 mt-4 pt-2">
                        <div class="media align-items-center rounded shadow p-3">
                            <h6 class="ml-3 mb-0 text-dark">New Arrivals</h6>
                        </div>
                    </div>
                    <div class="col-lg-6 mt-4 pt-2">
                        <div class="media align-items-center rounded shadow p-3">
                            <h6 class="ml-3 mb-0 text-dark">Customer Support</h6>
                        </div>
                    </div>
                    <div class="col-lg-6 mt-4 pt-2">
                        <div class="media align-items-center rounded shadow p-3">
                            <h6 class="ml-3 mb-0 text-dark">Style & Design</h6>
                        </div>
                    </div>
                </div>
            </div>
